...
SECRET_KEY = 'django-insecure-t11d%*k6warlq^e@aezishyb1fr2et8(otb(qvdj5r7h1g6nss'
SECURE_TRUSTED_ORIGINS = ['http://localhost', 'https://127.0.0.1:6015']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',')
CORS_ALLOWED_ORIGINS = ['http://localhost', 'https://127.0.0.1:6015', 'http://localhost:6015']
...
APP_STORAGE = os.path.join(BASE_DIR, 'app_storage')
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'your_app.pipeline.save_github_social_auth',  # 自定义管道
